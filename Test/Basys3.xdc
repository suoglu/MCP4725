...
set_property PACKAGE_PIN U1 [get_ports {update}]
	set_property IOSTANDARD LVCMOS33 [get_ports {update}]
set_property PACKAGE_PIN T1 [get_ports {i2cSpeed[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {i2cSpeed[0]}]
set_property PACKAGE_PIN R2 [get_ports {i2cSpeed[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {i2cSpeed[1]}]
...
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {A0}]
